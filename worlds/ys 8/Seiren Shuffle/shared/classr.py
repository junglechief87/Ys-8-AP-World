...
class access:
  ...
  def canMove(self,requiredCrew):
    ...
    for item in self.inventoryObjects:
      if item.crew and item.itemID != 778: #I used the curran2 and austen2 NPC allocated space to make kong and shoebill count towards village totals and used reserve slots for others.
        count+=1
