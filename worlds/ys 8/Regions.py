...
def create_regions(Ys8World):
    ...
    region_connections = {
        ...
        "Ruins of Eternia": ["Seiren North Access", "Temple of the Great Tree", "Entrance: Archeozoic Chasm", "Towal Highway", "Entrance: Former Sanctuary Crypt", 
                             "Bolado Monastery"],
        ...
        "Former Sanctuary Crypt Third Floor": ["Former Sanctuary Crypt Second Boss Arena", "Former Sanctuary Crypt Third Barrier", 
        ...
        "Former Sanctuary Crypt Final Floors": ["Former Sanctuary Crypt Third Barrier", "Former Sanctuary Crypt Boss Room", 
